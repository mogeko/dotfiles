#
# ~/.zshrc.d/99-setup-iterm2-integration.zsh
#
...
# -- BEGIN ITERM2 UTILITIES --
alias imgcat="${HOME}/.iterm2/utilities/imgcat"
alias it2check="${HOME}/.iterm2/utilities/it2check"
alias it2copy="${HOME}/.iterm2/utilities/it2copy"
alias it2dl="${HOME}/.iterm2/utilities/it2dl"
alias it2setcolor="${HOME}/.iterm2/utilities/it2setcolor"

# -- END ITERM2 UTILITIES --
